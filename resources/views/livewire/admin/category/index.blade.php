    ...
    <div class="">
        ...
        <div class="col-md-12">
            ...
            <div class="card-header">
                <h3 class="fs-2 text-primary">Category
                    <span>
                        <i class="mdi mdi-message-alert menu-icon"></i>
                    </span>
                    <a href="{{ url('admin/category/create') }}"
                        class="btn btn-outline-primary btn-sm float-end my-2">Add Category</a>
                </h3>
            </div>
                ...
                <table class="table table-hover table-bordered table-striped">
                    ...
                    <tbody>
                        @foreach ($categories as $category)
                            <tr>
                                <td>{{ $category->id }}</td>
                                <td class="letter-spaced">{{ $category->name}}</td>
                                <td class="letter-spaced">{{ $category->product_description}}</td>
                                <td class="letter-spaced">{{ $category->status == '1' ? 'Hidden':'Visible'}}</td>
                                <td class="">
